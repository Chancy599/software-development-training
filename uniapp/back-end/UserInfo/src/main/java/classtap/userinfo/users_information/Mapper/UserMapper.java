package classtap.userinfo.users_information.Mapper;
...
public interface UserMapper {
    @Insert("INSERT INTO users_information (id,name,password,gender,contact_information) VALUES (#{id},#{name},#{password},#{gender},#{contact_information})")
