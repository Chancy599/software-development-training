<template>
  <view class="container">
    ...
    <view class="grid-container">
      <!-- 第一行 -->
      <view class="grid-row">
        <view class="grid-item" @click="navigateTo('pages/Location_Launch/Location_Launch')">
          <image class="grid-icon" src="/static/Method/GPS.png"></image>
          <text class="grid-text">定位签到</text>
        </view>
        <view class="grid-item" @click="navigateTo('pages/Cipher_Launch/Cipher_Launch')">
      ...
      <!-- 第二行 -->
      <view class="grid-row">
        <view class="grid-item" @click="navigateTo('pages/QRCode_Launch/QRCode_Launch')">
          <image class="grid-icon" src="/static/Method/QRCode.png"></image>
          <text class="grid-text">二维码签到</text>
        </view>
        <view class="grid-item" @click="navigateTo('pages/Face_Launch/Face_Launch')">
