  ...
  methods: {
    ...
    async NewClass() {
      ...
      try {
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at pages/OrgCreate/OrgCreate.vue:84", "创建班级失败:", error);
        common_vendor.index.showToast({
    ...
    async updateManageBelong() {
      return new Promise((resolve, reject) => {
        common_vendor.wx$1.cloud.callContainer({
          ...
          method: "PUT",
          success: (res) => {
            common_vendor.index.__f__("log", "at pages/OrgCreate/OrgCreate.vue:125", "管理员归属更新成功:", res);
            resolve(res);
          },
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/OrgCreate/OrgCreate.vue:129", "管理员归属更新失败:", err);
            reject(err);
          }
        });
      });
    ...
    async updateBelong(id) {
      return new Promise((resolve, reject) => {
        common_vendor.wx$1.cloud.callContainer({
          ...
          method: "PUT",
          success: (res) => {
            common_vendor.index.__f__("log", "at pages/OrgCreate/OrgCreate.vue:149", `学生 ${id} 归属更新成功:`, res);
            resolve(res);
          },
          fail: (err) => {
            common_vendor.index.__f__("error", "at pages/OrgCreate/OrgCreate.vue:153", `学生 ${id} 归属更新失败:`, err);
            reject(err);
          }
        });
      });
